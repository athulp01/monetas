...
export const updatePayee = (id: string, payee: Prisma.PayeeUpdateInput, client: PrismaClient) => {
...
export const getPayees = (categoryId: string | undefined, client: PrismaClient) =>
  client.payee.findMany({
    include: { categories: true },
    where: categoryId ? { categories: { some: { id: categoryId } } } : undefined,
  })

export const addPayee = (payee: Prisma.PayeeCreateInput, client: PrismaClient) =>
...
export const addPayeeAlias = (payeeId: string, alias: string, client: PrismaClient) =>
