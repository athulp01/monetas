...
export default function AsideMenuLayer({ menu, className = '', ...props }: Props) {
  ...
  return (
    ...
    >
      <div
        className={`flex flex-1 flex-col overflow-hidden dark:bg-slate-900 lg:rounded-2xl ${asideStyle}`}
      >
        <div
        ...
        >
          <div className="flex flex-1 justify-center align-middle lg:pl-6 lg:text-left xl:pl-0 xl:text-center">
            <Image src="/logo/svg/logo-no-background.svg" width={150} height={150} alt="logo" />
          </div>
          <button
            aria-label="close"
